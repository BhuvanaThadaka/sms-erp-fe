              ...
              >
                <div className="flex gap-3">
                  <div className={clsx(
                    ...
                    notif.type === 'EVENT_CREATED' ? 'bg-azure-500/20 text-azure-400' : 'bg-slate-500/20 text-slate-400'
                  )}>
                    {notif.type === 'EVENT_CREATED' ? <Calendar className="w-4 h-4" /> : <Info className="w-4 h-4" />}
                  </div>
